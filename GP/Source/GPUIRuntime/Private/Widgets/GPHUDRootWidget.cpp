...
EMouseCursor::Type UGP_HUDRootWidget::GetCommandTargetingCursor() const
{
	if (const AGP_PlayerController* PlayerController = Cast<AGP_PlayerController>(GetOwningPlayer()))
	{
