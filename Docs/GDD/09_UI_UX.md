...
- **MainBase PURCHASE** (navigation implemented; catalog/spend not yet): Actions → PurchaseRoot →
  Units / Buildings / Defense. Back is context-sensitive. Bottom-center stays on MainBase info.
