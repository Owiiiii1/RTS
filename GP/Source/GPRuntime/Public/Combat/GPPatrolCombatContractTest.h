...
#include "GPPatrolCombatContractTest.generated.h"

/** Patrol A↔B temporary combat engagement contract runner. */
UCLASS()
class GPRUNTIME_API UGP_PatrolCombatContractTestRunner : public UObject
{
	GENERATED_BODY()
