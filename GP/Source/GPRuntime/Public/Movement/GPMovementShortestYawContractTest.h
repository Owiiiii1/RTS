...
#include "GPMovementShortestYawContractTest.generated.h"

/** GP-S41M shortest-yaw movement facing contract runner. */
UCLASS()
class GPRUNTIME_API UGP_MovementShortestYawContractTestRunner : public UObject
{
	GENERATED_BODY()
