...
/** Worker orchestration view (GP-S27). MiningComponent remains SoT for mining execution. */
UENUM(BlueprintType)
...
/**
 * Production Worker: MobileUnit + Cargo + Mining (GP-S27).
 * Mine execution is orchestrated by UGP_UnitCommandComponent (serial-aware movement).
 * No Storage / return-to-base / auto-attack / CombatComponent.
 */
