...
- [ADR_0009_Orbital_Delivery_Pillar](ADR_0009_Orbital_Delivery_Pillar.md) — All non-initial assets arrive via orbital drop pods. No local production / construction.
